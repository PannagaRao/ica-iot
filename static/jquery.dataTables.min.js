...
!(function (n) {
  ...
  function l(t, e, n) {
    ...
    return (
      ...
      "bigint" == a ||
      !!h(t) ||
      (e && r && (t = $(t, e)), n && r && (t = t.replace(q, "")), !isNaN(parseFloat(t)) && isFinite(t))
    );
  }
  function a(t, e, n) {
    var a;
  ...
  var p,
        ...
        (this.fnGetData = function (t, e) {
          ...
          return t !== H
            ? ((n = t.nodeName ? t.nodeName.toLowerCase() : ""),
              e !== H || "td" == n || "th" == n ? a.cell(t, e).data() : a.row(t).data() || null)
            : a.data().toArray();
        }),
    ...
    $ = function (t, e) {
      return (
        c[e] || (c[e] = new RegExp(Ot(e), "g")), "string" == typeof t && "." !== e ? t.replace(/\./g, "").replace(c[e], ".") : t
      );
    },
    N = function (t, e, n) {
      var a = [],
      ...
      if (((l = []), !(o = s[f]).sType && o._sManualType)) o.sType = o._sManualType;
        ...
        for (e = 0, n = c.length; e < n; e++) {
          for (
            a = 0, r = u.length;
            a < r &&
            (l[a] === H && (l[a] = S(t, a, f, "type")), (i = c[e](l[a], t)) || e === c.length - 1) &&
            ("html" !== i || h(l[a]));
            a++
          );
          if (i) {
  ...
  function St(t, e, n, a) {
    ...
    if (null === c.nTr) {
      for (
        r = n || v.createElement("tr"), c.nTr = r, c.anCells = d, r._DT_RowIndex = e, vt(t, c), l = 0, s = t.aoColumns.length;
        l < s;
        l++
      )
        (i = t.aoColumns[l]),
    ...
    if (g || (!h && !l && !i && s == T(t) && s == c.length))
      ...
      for (
        ...
        (e = r[u[_]]),
          ...
          e.sWidthOrig &&
            l &&
            P(c[_]).append(P("<div/>").css({ width: e.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
      if (t.aoData.length)
        for (_ = 0; _ < u.length; _++) (e = r[(n = u[_])]), P(re(t, n)).clone(!1).append(e.sContentPadding).appendTo(v);
      ...
      if (-1 !== P.inArray(!1, l)) n._bLoadingState = !1;
        ...
        if (0 < l && t.time < +new Date() - 1e3 * l) n._bLoadingState = !1;
          ...
          if (
            ...
            t.start !== H &&
              (null === i ? ((n._iDisplayStart = t.start), (n.iInitDisplayStart = t.start)) : Yt(n, t.start / n._iDisplayLength)),
            t.order !== H &&
              ((n.aaSorting = []),
  ...
  function _e(t, e, n, a, r) {
    for (
      var o,
        ...
        c = typeof e,
        f = 0,
        d = (e = e && "string" != c && "function" != c && e.length !== H ? e : [e]).length;
      f < d;
      f++
    )
      ...
      (e(je, function (t, e) {
        ...
        return t === H
          ? n.length && this.length
            ...
            : H
          : (!0 === t ? this.child.show() : !1 === t ? Re(this) : n.length && this.length && Te(n[0], n[0].aoData[this[0]], t, e),
            this);
      }),
  ...
  function Oe(t, e) {
    ...
    return (
      e <= a
        ...
        : ((e - 1 - r <= t ? (n = f(e - (a - 2), e)) : ((n = f(t - r + 2, t + r - 1)).push("ellipsis"), n.push(e - 1), n)).splice(
            0,
            0,
            "ellipsis"
          ),
